...
we will be able to both improve the quality of their libraries.
...
The kernels we plan to work on are Intrepid, a tensor manipulation library,
and a kernel from this list: x, y, z.
